...
<script>
	...
	methods:{
		...
		desabilitarBotaoSalvar(){
			if(this.tarefa.titulo === "" || this.tarefa.titulo.length < 3 || this.tarefa.titulo.length > 20 ) return true;
			if(this.tarefa.descricao === "" || this.tarefa.descricao.length < 5 || this.tarefa.descricao > 30) return true;
